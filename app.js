...
const strategies = [
  ...
  { title: "看封底與書腰介紹", detail: "快速找出作者想解決什麼問題，以及出版社主打的重點。" },
...
const books = [
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "下列哪組最接近本書的重要關鍵概念？", options: ["行為改變 ／負面偏見／潛意識", "領導力／說服力／談判技巧", "意志力／競爭／效率", "靈感／創業／冒險"], answer: 0 }
    ]
  },
  {
    id: "determined",
    ...
    questions: [
      ...
      { question: "最接近本書的核心概念是什麼？", options: ["命運／儀式／預言", "基因與激素／意志力訓練／決策技巧", "道德哲學／不確定性／緩解焦慮", "決定論／自由意志的不存在／重新思考懲罰 "], answer: 3 }
    ]
  },
  {
    id: "work",
    ...
    questions: [
      ...
      { question: "最接近本書的核心概念是什麼？", options: ["狩獵採集／能量與熵／稀缺性", "生涯探索／斜槓／被動收入", "KPI／科技生產力／時間管理", "領導力／組織設計／企業文化"], answer: 0 }
    ]
  }
];
